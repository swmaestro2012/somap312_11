...
private:
	...
	//편집
	MakeFunctionFunctionTable _makeFunctionFunctionTable;
	MakeClassFunctionFunctionsTable _makeClassFunctionFunctionsTable;
	MakeClassVariableFunctionsTable _makeClassVariableFunctionsTable;
