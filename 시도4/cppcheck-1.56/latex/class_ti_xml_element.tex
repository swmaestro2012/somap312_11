...
\hypertarget{class_ti_xml_element_af5cd4156e082ef3bf23adfe0ed173340}{\index{Ti\-Xml\-Element@{Ti\-Xml\-Element}!operator=@{operator=}}
\index{operator=@{operator=}!TiXmlElement@{Ti\-Xml\-Element}}
\subsubsection[{operator=}]{\setlength{\rightskip}{0pt plus 5cm}void Ti\-Xml\-Element\-::operator= (
\begin{DoxyParamCaption}
